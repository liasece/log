...
// NewCore creates a zap core that writes logs to a sentry client.
...
// ClientGetter is a interface of get sentry client.
...
// AttachCoreToLogger append a zap core to zap logger
